...
test/live-acceptance.test.ts. Polls `<project>/.omb-e2e/cmd-N.py` command files
...
_PROJECT_DIR_VALUE = _argv_option("--omb-project-dir") or os.environ.get("OMB_PROJECT_DIR")
if not _PROJECT_DIR_VALUE:
    raise RuntimeError("live-acceptance sidecar requires --omb-project-dir")
PROJECT_DIR = Path(_PROJECT_DIR_VALUE).expanduser().resolve()
COMMAND_DIR = PROJECT_DIR / ".omb-e2e"
...
print("OMB_E2E_SIDECAR: ready", flush=True)
