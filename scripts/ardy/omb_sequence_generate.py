...
# SPDX-FileCopyrightText: oh-my-blender contributors
#
# omb-owned script. Source of truth lives in the oh-my-blender repo at
# scripts/ardy/omb_sequence_generate.py and is deployed to the ARDY box at
# ~/ardy/scripts/omb_sequence_generate.py. Do not edit the deployed copy.
"""Segment-chained text-to-motion generation for the omb ARDY pipeline.
...
Usage (from ~/ardy):
    .venv/bin/python scripts/omb_sequence_generate.py \
        --segment "A person runs forward." 3 \
        --segment "A person bows deeply." 4 \
        --output outputs/omb/seq --seed 7
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Segment-chained autoregressive text-to-motion generation (omb)"
    )
    parser.add_argument(
        "--segment",
        action="append",
