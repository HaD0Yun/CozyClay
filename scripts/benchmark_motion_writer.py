...
SCHEMA = "omb.motion_writer_benchmark.v1"
RESULT_PREFIX = "OMB_STAGE_CHARACTER_RESULTS="
WRITER_ORDER_ENV = "OMB_BENCHMARK_WRITER_ORDER"
TERMINAL_SCHEMA = "omb.stage_scene_motion.v2"
DEFAULT_WARMUPS = 3
DEFAULT_RUNS = 31
...
HASHED_INPUTS = (
    "blender-addon/oh_my_blender/stage_scene.py",
    "blender-addon/oh_my_blender/motion_retarget.py",
    "blender-addon/tests/fixtures/stage_scene_character_fixture.py",
    "blender-addon/oh_my_blender/assets/characters/y-bot-tpose.fbx",
    "blender-addon/oh_my_blender/assets/characters/x-bot-tpose.fbx",
)
METRICS = (
    "bulkMedianMs",
    "legacyMedianMs",
