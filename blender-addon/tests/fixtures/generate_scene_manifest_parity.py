"""Generate the real-Blender SceneManifestV4 parity fixture.

Regenerate from the repository root:

    blender --background --python blender-addon/tests/fixtures/generate_scene_manifest_parity.py -- \
      --output packages/director-core/test/fixtures/scene-manifest-v4-parity.json
"""
