...
from oh_my_blender import motion_preflight, motion_retarget, scene_relations
from oh_my_blender.motion_preflight import (
    MAX_CONTACT_WINDOWS,
...
from oh_my_blender.stage_scene import StageSceneError
...
class _FakeObject:
    ...
    def get(self, key):
        return self._entity_id if key == "omb.entity_id" else None
