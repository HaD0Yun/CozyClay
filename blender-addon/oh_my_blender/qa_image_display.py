...
def display_qa_artifact(
    ...
    *,
    ...
    image = None
    try:
        descriptor, temporary_path = tempfile.mkstemp(prefix="omb-qa-", suffix=".png")
        try:
...
def _read_verified_payload(project: Path, digest: str) -> bytes:
    ...
    try:
        ...
        for component in (".omb", "artifacts", digest):
